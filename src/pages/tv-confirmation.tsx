...
const [loading, setLoading] = useState(false);
  ...
  const BUY_TVSUBSCRIPTION_ENDPOINT = '/api/v1/bills/tvSubscription'
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        const response = await axios.post(BUY_TVSUBSCRIPTION_ENDPOINT,
            values,
            {
...
TvConfirmation.getLayout = function getLayout(page: ReactElement) {
  return <LayoutAuthenticated>{page}</LayoutAuthenticated>
}

export default TvConfirmation
